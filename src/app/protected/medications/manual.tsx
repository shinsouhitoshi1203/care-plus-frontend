...
import { Calendar, CheckCircle2, Plus, Trash2 } from "lucide-react-native";
...
export default function ManualMedicationScreen() {
  ...
  const createMutation = useMutation({
    mutationFn: async (payload: any) => await MedicationAPI.createSchedule(familyId!, memberId!, payload),
    onSuccess: () => {
